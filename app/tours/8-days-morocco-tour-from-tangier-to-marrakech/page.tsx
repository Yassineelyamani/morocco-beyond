...
export const metadata: Metadata = {
  title: '8 Days Morocco Tour from Tangier to Marrakech | Morocco Beyond',
  description: 'Luxury 8-day Morocco tour from Tangier to Marrakech. Explore Tangier, Chefchaouen, Fes, Merzouga Desert, Atlas Mountains, and Marrakech with private guides.',
  openGraph: {
    title: '8 Days Morocco Tour from Tangier to Marrakech | Morocco Beyond',
    description: 'Luxury 8-day Morocco tour from Tangier to Marrakech. Explore Tangier, Chefchaouen, Fes, Merzouga Desert, Atlas Mountains, and Marrakech with private guides.',
  },
...
export default function EightDaysMoroccoTourTangierMarrakech() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'TouristTrip',
    name: '8 Days Morocco Tour from Tangier to Marrakech',
    description: 'Luxury 8-day Morocco tour from Tangier to Marrakech exploring the imperial cities and desert.',
      ...
      <main className="min-h-screen bg-[#060506] text-white">
        ...
        <section className="relative h-[60vh] flex items-center justify-center bg-gradient-to-b from-amber-900/20 to-[#060506]">
          <div className="text-center px-6">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 text-amber-400">8 Days Morocco Tour from Tangier to Marrakech</h1>
            <p className="text-xl text-gray-300">Imperial Cities & Desert Experience</p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
            Experience the best of northern Morocco on this 8-day luxury tour from Tangier to Marrakech. From the coastal charm of Tangier to the blue streets of Chefchaouen, the ancient medina of Fes, the golden dunes of Merzouga, and the vibrant city of Marrakech, this tour covers Morocco's most iconic destinations. Enjoy luxury accommodation, private guides, and authentic cultural experiences throughout your journey.
          </p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 bg-gradient-to-b from-transparent to-amber-900/10">
          ...
          <div className="space-y-8">
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 1: Arrival in Tangier</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Airport pickup and transfer to hotel</li>
                <li>Explore the historic medina of Tangier</li>
                <li>Visit the Kasbah and Museum of Moroccan Arts</li>
                <li>Enjoy sunset at Cape Spartel</li>
                <li>Welcome dinner at a local restaurant</li>
                <li>Overnight in luxury hotel in Tangier</li>
              </ul>
            </div>

            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 2: Tangier to Chefchaouen</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 4: Full Day in Fes</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 5: Fes to Merzouga Desert</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 6: Merzouga to Ouarzazate</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 7: Ouarzazate to Marrakech</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 8: Full Day in Marrakech & Departure</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
                ...
                <li>Traditional lunch at Jemaa el-Fna square</li>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">Contact us to book your imperial cities and desert adventure.</p>
