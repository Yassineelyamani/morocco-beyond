...
export const metadata: Metadata = {
  title: '4 Days Marrakech to Merzouga Desert Tour | Morocco Beyond',
  description: 'Extended 4-day luxury desert tour from Marrakech to Merzouga. Explore Ait Ben Haddou, Dades Gorges, Todra Gorge, and enjoy camel trekking with more time to experience the Sahara.',
  openGraph: {
    title: '4 Days Marrakech to Merzouga Desert Tour | Morocco Beyond',
    description: 'Extended 4-day luxury desert tour from Marrakech to Merzouga. Explore Ait Ben Haddou, Dades Gorges, Todra Gorge, and enjoy camel trekking with more time to experience the Sahara.',
  },
...
export default function FourDaysMarrakechMerzougaTour() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'TouristTrip',
    name: '4 Days Marrakech to Merzouga Desert Tour',
    description: 'Extended 4-day luxury desert tour from Marrakech to Merzouga with more time to experience the Sahara.',
      ...
      <main className="min-h-screen bg-[#060506] text-white">
        ...
        <section className="relative h-[60vh] flex items-center justify-center bg-gradient-to-b from-amber-900/20 to-[#060506]">
          <div className="text-center px-6">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 text-amber-400">4 Days Marrakech to Merzouga Desert Tour</h1>
            <p className="text-xl text-gray-300">Extended Sahara Desert Experience</p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
            Extend your desert adventure with this 4-day luxury tour from Marrakech to Merzouga. This journey gives you more time to explore the stunning landscapes of Morocco, from the dramatic Atlas Mountains to the golden sand dunes of Erg Chebbi. Visit the UNESCO World Heritage site of Ait Ben Haddou, explore the breathtaking Dades and Todra Gorges, enjoy a sunset camel trek, and spend two magical nights under the stars in a luxury desert camp.
          </p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 bg-gradient-to-b from-transparent to-amber-900/10">
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 3: Full Day in Merzouga Desert</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 4: Merzouga to Marrakech</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Wake up early for sunrise over the dunes</li>
                <li>Breakfast at the desert camp</li>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="space-y-6">
            <div className="bg-amber-900/20 p-6 rounded-lg">
              ...
              <p className="text-gray-300">The tour includes luxury accommodation, private transportation, English-speaking guide, all meals as specified, camel trek, and two nights in a desert camp.</p>
            </div>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">Contact us to book your extended luxury desert adventure.</p>
