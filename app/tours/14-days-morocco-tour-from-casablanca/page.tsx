...
export const metadata: Metadata = {
  title: '14 Days Morocco Tour from Casablanca | Morocco Beyond',
  description: 'Ultimate 14-day luxury Morocco tour from Casablanca. Discover all of Morocco including Casablanca, Rabat, Chefchaouen, Fes, Merzouga Desert, Marrakech, Essaouira, and more.',
  openGraph: {
    title: '14 Days Morocco Tour from Casablanca | Morocco Beyond',
    description: 'Ultimate 14-day luxury Morocco tour from Casablanca. Discover all of Morocco including Casablanca, Rabat, Chefchaouen, Fes, Merzouga Desert, Marrakech, Essaouira, and more.',
  },
...
export default function FourteenDaysMoroccoTourCasablanca() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'TouristTrip',
    name: '14 Days Morocco Tour from Casablanca',
    description: 'Ultimate 14-day luxury Morocco tour from Casablanca exploring all of Morocco.',
      ...
      <main className="min-h-screen bg-[#060506] text-white">
        ...
        <section className="relative h-[60vh] flex items-center justify-center bg-gradient-to-b from-amber-900/20 to-[#060506]">
          <div className="text-center px-6">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 text-amber-400">14 Days Morocco Tour from Casablanca</h1>
            <p className="text-xl text-gray-300">Ultimate Morocco Experience</p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
            Experience the ultimate Morocco adventure on this comprehensive 14-day luxury tour starting from Casablanca. From the modern metropolis of Casablanca to the blue streets of Chefchaouen, the ancient medina of Fes, the golden dunes of Merzouga, the vibrant city of Marrakech, and the coastal charm of Essaouira, this tour covers all of Morocco's highlights and hidden gems. Enjoy luxury accommodation, private guides, and authentic cultural experiences throughout your journey.
          </p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 bg-gradient-to-b from-transparent to-amber-900/10">
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 7: Full Day in Merzouga Desert</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Sunrise over the dunes</li>
                <li>Breakfast at the desert camp</li>
                <li>Explore the surrounding desert villages</li>
                <li>Visit nomadic families and learn about their lifestyle</li>
                <li>Sandboarding or 4x4 desert adventure (optional)</li>
                <li>Sunset camel trek to a different dune area</li>
                <li>Traditional Berber dinner and entertainment</li>
                <li>Second night in the luxury desert camp</li>
              </ul>
            </div>

            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 8: Merzouga to Ouarzazate</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Sunrise over the dunes</li>
                <li>Breakfast at the desert camp</li>
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 9: Ouarzazate to Marrakech</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 10: Full Day in Marrakech</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
            ...
            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 11: Marrakech to Essaouira</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
                <li>Drive to the coastal city of Essaouira</li>
                <li>Explore the historic medina and port</li>
                <li>Visit the Skala fortress</li>
                <li>Relax on the beach</li>
                <li>Overnight in a luxury riad in Essaouira</li>
              </ul>
            </div>

            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 12: Full Day in Essaouira</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
                <li>Optional water sports or fishing trip</li>
                <li>Explore the argan oil cooperatives</li>
                <li>Visit the local markets</li>
                <li>Seafood dinner at a local restaurant</li>
                <li>Overnight in Essaouira</li>
              </ul>
            </div>

            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 13: Essaouira to Marrakech</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
                <li>Morning exploration of Essaouira</li>
                <li>Drive back to Marrakech</li>
                <li>Afternoon free time in Marrakech</li>
                <li>Farewell dinner at a traditional restaurant</li>
                <li>Overnight in Marrakech</li>
              </ul>
            </div>

            <div className="border-l-4 border-amber-500 pl-6">
              <h3 className="text-2xl font-bold mb-3">Day 14: Departure</h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Breakfast at the riad</li>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">Contact us to book your ultimate Morocco adventure.</p>
