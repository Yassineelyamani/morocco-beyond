  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-[#060506] text-white">
        ...
        <a
          href="https://wa.me/16266253284?text=Hello%20Morocco%20Beyond%2C%20I%20would%20like%20to%20learn%20more%20about%20your%20Morocco%20tours."
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[#25D366]/50"
